...
var G__27151 = devtools.prefs.pref.call(null,v);
v = G__27151;
continue;
} else {
return v;
...
}catch (e27154){var _e__26166__auto__ = e27154;
return false;
}})();
...
}catch (e27158){var _e__26166__auto__ = e27158;
return false;
}})();
...
}catch (e27160){var _e__26166__auto__ = e27160;
return false;
}}
}
});
...
var vec__27162 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27162,(0),null);
var name = cljs.core.nth.call(null,vec__27162,(1),null);
...
return cljs.core.some.call(null,(function (p1__27165_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27165_SHARP_);
}),template);
});
