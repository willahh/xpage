...
var G__25888 = o;
(G__25888[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25892 = o;
(G__25892[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25897 = props;
var G__25897__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25897,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25897);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25897__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25898){
...
var props = map__25899__$1;
var class$ = cljs.core.get.call(null,map__25899__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25899,map__25899__$1,props,class$){
return (function (c){
...
});})(map__25899,map__25899__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25901){
var map__25902 = p__25901;
var map__25902__$1 = ((((!((map__25902 == null)))?(((((map__25902.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25902.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25902):map__25902);
var on_write = cljs.core.get.call(null,map__25902__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25902,map__25902__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25902,map__25902__$1,on_write))
);
} else {
...
var G__25905 = jsprops;
(G__25905["defaultValue"] = value);

(G__25905["onChange"] = ((function (G__25905,v,value,on_change){
return (function (p1__25904_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25904_SHARP_);
});})(G__25905,v,value,on_change))
);
...
var vec__25908 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25908,(0),null);
var id = cljs.core.nth.call(null,vec__25908,(1),null);
var class$ = cljs.core.nth.call(null,vec__25908,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___25912 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___25912 == null)){
} else {
var key_25913 = temp__5461__auto___25912;
(jsprops["key"] = key_25913);
}
...
var temp__5461__auto___25914 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___25914 == null)){
} else {
var key_25915 = temp__5461__auto___25914;
reagent.impl.template.oset.call(null,jsprops,"key",key_25915);
}
...
var G__25916 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25916["name"] = c);
...
var len__4531__auto___25921 = arguments.length;
var i__4532__auto___25922 = (0);
while(true){
if((i__4532__auto___25922 < len__4531__auto___25921)){
args__4534__auto__.push((arguments[i__4532__auto___25922]));

var G__25923 = (i__4532__auto___25922 + (1));
i__4532__auto___25922 = G__25923;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25919){
var G__25920 = cljs.core.first.call(null,seq25919);
var seq25919__$1 = cljs.core.next.call(null,seq25919);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25920,seq25919__$1);
});
...
break;
default:
var G__25926 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25926;
continue;
...
var n__4408__auto___25928 = a.length;
var i_25929 = (0);
while(true){
if((i_25929 < n__4408__auto___25928)){
(a[i_25929] = reagent.impl.template.as_element.call(null,(a[i_25929])));

var G__25930 = (i_25929 + (1));
i_25929 = G__25930;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___25931 = a.length;
var i_25932 = (0);
while(true){
if((i_25932 < n__4408__auto___25931)){
var val_25933 = (a[i_25932]);
if(((cljs.core.vector_QMARK_.call(null,val_25933)) && ((reagent.impl.template.key_from_vec.call(null,val_25933) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25932] = reagent.impl.template.as_element.call(null,val_25933));

var G__25934 = (i_25932 + (1));
i_25932 = G__25934;
continue;
} else {
}
...
var ctx = ({});
var vec__25935 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25935,(0),null);
var derefed = cljs.core.nth.call(null,vec__25935,(1),null);
...
var G__25938 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25938) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25938){
