...
var G__25205 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__25205,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__25205;
}
});
...
args__4534__auto__.push((arguments[i__4532__auto___25211]));
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq25207){
var G__25208 = cljs.core.first.call(null,seq25207);
var seq25207__$1 = cljs.core.next.call(null,seq25207);
var G__25209 = cljs.core.first.call(null,seq25207__$1);
var seq25207__$2 = cljs.core.next.call(null,seq25207__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25208,G__25209,seq25207__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__25214,map__25214__$1,file,line,column){
return (function (p1__25213_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__25213_SHARP_));
});})(map__25214,map__25214__$1,file,line,column))
...
var temp__5457__auto___25216 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___25216)){
var message_25217 = temp__5457__auto___25216;
cljs.core.println.call(null,message_25217);
} else {
}
...
var temp__5457__auto___25218 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___25218)){
var message_25219 = temp__5457__auto___25218;
cljs.core.println.call(null,message_25219);
} else {
}
...
var output_dir__$1 = (function (){var G__25220 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25220),"/"].join('');
} else {
return G__25220;
}
})();
...
var G__25222 = exception.stack;
var G__25222__$1 = (((G__25222 == null))?null:clojure.string.split_lines.call(null,G__25222));
var G__25222__$2 = (((G__25222__$1 == null))?null:cljs.core.get.call(null,G__25222__$1,depth));
if((G__25222__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__25222__$2);
}
} else {
...
var vec__25223 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__25223,(0),null);
var column = cljs.core.nth.call(null,vec__25223,(1),null);
var vec__25226 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__25226,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__25226,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__25226,(2),null);
...
var m__$1 = (function (){var G__25229 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__25233 = (function (){var G__25232 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__25232);
} else {
return G__25232;
}
})();
...
return cljs.core.vary_meta.call(null,G__25234,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__25238 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__25238,(0),null);
var types = vec__25238;
...
return cljs.core.map.call(null,(function (p__25241){
var vec__25242 = p__25241;
var ns = cljs.core.nth.call(null,vec__25242,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__25242,(1),null);
return ((function (vec__25242,ns,vars__$1){
return (function (){
...
var G__25245 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1){
return (function (){
var seq__25246 = cljs.core.seq.call(null,vars__$1);
var chunk__25247 = null;
var count__25248 = (0);
var i__25249 = (0);
while(true){
if((i__25249 < count__25248)){
var v = cljs.core._nth.call(null,chunk__25247,i__25249);
var temp__5457__auto___25251 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___25251)){
var t_25252 = temp__5457__auto___25251;
each_fixture_fn.call(null,((function (seq__25246,chunk__25247,count__25248,i__25249,t_25252,temp__5457__auto___25251,v,each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25252)));
});})(seq__25246,chunk__25247,count__25248,i__25249,t_25252,temp__5457__auto___25251,v,each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1))
);
} else {
}
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__25246);
if(temp__5457__auto__){
var seq__25246__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__25246__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__25246__$1);
...
var v = cljs.core.first.call(null,seq__25246__$1);
var temp__5457__auto___25261__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___25261__$1)){
var t_25262 = temp__5457__auto___25261__$1;
each_fixture_fn.call(null,((function (seq__25246,chunk__25247,count__25248,i__25249,t_25262,temp__5457__auto___25261__$1,v,seq__25246__$1,temp__5457__auto__,each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25262)));
});})(seq__25246,chunk__25247,count__25248,i__25249,t_25262,temp__5457__auto___25261__$1,v,seq__25246__$1,temp__5457__auto__,each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1))
);
} else {
}


var G__25263 = cljs.core.next.call(null,seq__25246__$1);
var G__25264 = null;
var G__25265 = (0);
var G__25266 = (0);
seq__25246 = G__25263;
chunk__25247 = G__25264;
count__25248 = G__25265;
i__25249 = G__25266;
continue;
}
} else {
...
});})(each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1))
);
});})(each_fixture_fn,G__25245,G__25245__$1,env,once_fixtures,each_fixtures,vec__25242,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25245__$1)].join('')));

}
})());
});
;})(vec__25242,ns,vars__$1))
