...
var len__4531__auto___26081 = arguments.length;
var i__4532__auto___26082 = (0);
while(true){
if((i__4532__auto___26082 < len__4531__auto___26081)){
args__4534__auto__.push((arguments[i__4532__auto___26082]));

var G__26083 = (i__4532__auto___26082 + (1));
i__4532__auto___26082 = G__26083;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq26078){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26079,G__26080,seq26078__$2);
});
...
var vec__26084 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__26084,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__26084,(1),null);
var G__26087 = cljs.core.PersistentArrayMap.EMPTY;
var G__26087__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__26087,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26087);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__26087__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__26087__$1;
}
} else {
...
return (function() { 
var G__26091__delegate = function (klass,contents){
var vec__26088 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__26088,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__26088,(1),null);
...
var G__26091 = function (klass,var_args){
var contents = null;
...
while (G__26092__i < G__26092__a.length) {G__26092__a[G__26092__i] = arguments[G__26092__i + 1]; ++G__26092__i;}
  contents = new cljs.core.IndexedSeq(G__26092__a,0,null);
} 
return G__26091__delegate.call(this,klass,contents);};
G__26091.cljs$lang$maxFixedArity = 1;
G__26091.cljs$lang$applyTo = (function (arglist__26093){
var klass = cljs.core.first(arglist__26093);
var contents = cljs.core.rest(arglist__26093);
return G__26091__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__26097){
...
var ns = cljs.core.get.call(null,map__26098__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__26098__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__26100){
...
var actual = cljs.core.get.call(null,map__26101__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__26101__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__26103){
...
var expected = cljs.core.get.call(null,map__26104__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__26104__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__26106_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__26108 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__26108__$1;
var name = cljs.core.get.call(null,map__26108__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__26108,map__26108__$1,info,name,line,file,node){
return (function (p1__26107_SHARP_){
return cljs.core.cons.call(null,node,p1__26107_SHARP_);
});})(curr_node,map__26108,map__26108__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__26110){
...
var m = map__26111__$1;
var fail = cljs.core.get.call(null,map__26111__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__26111__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__26111__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__26111__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___26113 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___26113)){
var message_26114 = temp__5457__auto___26113;
cljs.core.println.call(null,message_26114);
} else {
}
...
var temp__5457__auto___26115 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___26115)){
var message_26116 = temp__5457__auto___26115;
cljs.core.println.call(null,message_26116);
} else {
}
